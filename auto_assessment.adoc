...
These metrics should be defined in the link:lab_repository.adoc[VL Repository Component] and they should be referenced here. The values stands as a contract between these components.
