...
. perentage of cli interfaces with label
====
...
The tasks should be logically disconected from each other and they shouldn't be coupled, so each task can run independently. There are several design patterns that can be used to achieve this result.
